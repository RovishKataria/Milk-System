        ...
        pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (payerName != null && vpa != null && sendAmount != null && msgNote != null) {
                    ...
                    Toast.makeText(DeliveryPersonActivity.this,
...
//        } else {
//            Toast.makeText(this, "Paytm is not installed Please install and try again.",
...
//        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if ((RESULT_OK == resultCode) && status.equals("success")) {
            Toast.makeText(DeliveryPersonActivity.this, "Transaction successful." +
                    data.getStringExtra("ApprovalRefNo"), Toast.LENGTH_SHORT).show();
            msg.setText("Transaction successful of ₹" + sendAmount);
            msg.setTextColor(Color.GREEN);
        } else {
            Toast.makeText(DeliveryPersonActivity.this,
                    "Transaction cancelled or failed please try again.", Toast.LENGTH_SHORT).show();
